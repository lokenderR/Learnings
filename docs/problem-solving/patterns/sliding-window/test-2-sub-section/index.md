...
[
  {
    ...
    "body": "Use this page to capture the core idea behind **test 2 sub section** and when this pattern should be considered.",
    "boxBackground": "blue",
    "boxBorder": "full",
    "boxPadding": "normal",
    "boxWidth": "normal",
    "pageTitle": "test 2 sub section"
  },
  {
    "id": "strategy-logic",
    "type": "logic",
...
<p>Use this page to capture the core idea behind <strong>test 2 sub section</strong> and when this pattern should be considered.</p>
