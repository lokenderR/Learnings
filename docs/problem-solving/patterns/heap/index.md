...
[
  {
    ...
    "body": "Use Heap when you repeatedly need the smallest or largest currently available item.",
    "boxBackground": "blue",
    "boxBorder": "full",
    "boxPadding": "normal",
    "boxWidth": "normal",
...
<p>Use Heap when you repeatedly need the smallest or largest currently available item.</p>
...
<div class="learning-list">
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Top K</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Merge sorted streams</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Scheduling by priority</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Dynamic minimum or maximum</span></div>
</div>
