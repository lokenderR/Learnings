...
[
  {
    ...
    "body": "Use Stack when the latest unresolved item should be handled first.",
    "boxBackground": "blue",
    "boxBorder": "full",
    "boxPadding": "normal",
    "boxWidth": "normal",
  ...
  },
  {
    ...
    "body": "- Nested structure\n- Matching pairs\n- Monotonic next greater/smaller relationships\n- Undo-like behavior",
    "boxBackground": "green",
    "boxBorder": "left",
    "boxPadding": "normal",
    "boxWidth": "normal"
...
<p>Use Stack when the latest unresolved item should be handled first.</p>
...
<div class="learning-list">
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Nested structure</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Matching pairs</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Monotonic next greater/smaller relationships</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Undo-like behavior</span></div>
</div>
