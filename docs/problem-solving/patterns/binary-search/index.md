...
[
  {
    ...
    "body": "Use Binary Search when the search space is ordered or when the answer can be tested with a monotonic predicate.",
    "boxBackground": "blue",
    "boxBorder": "full",
    "boxPadding": "normal",
    "boxWidth": "normal",
  ...
  },
  {
    ...
    "body": "- Find first/last valid position\n- Minimize the maximum or maximize the minimum\n- A condition flips from false to true across the answer space",
    "boxBackground": "green",
    "boxBorder": "left",
    "boxPadding": "normal",
    "boxWidth": "normal"
...
<p>Use Binary Search when the search space is ordered or when the answer can be tested with a monotonic predicate.</p>
...
<div class="learning-list">
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Find first/last valid position</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Minimize the maximum or maximize the minimum</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>A condition flips from false to true across the answer space</span></div>
</div>
