...
[
  {
    ...
    "body": "Use Greedy when a locally optimal choice can be proven to lead to a globally optimal answer.",
    "boxBackground": "blue",
    "boxBorder": "full",
    "boxPadding": "normal",
    "boxWidth": "normal",
  ...
  },
  {
    ...
    "body": "- Sorting by a meaningful key\n- Exchange argument is possible\n- Keeping the best current option is enough",
    "boxBackground": "green",
    "boxBorder": "left",
    "boxPadding": "normal",
    "boxWidth": "normal"
...
<p>Use Greedy when a locally optimal choice can be proven to lead to a globally optimal answer.</p>
...
<div class="learning-list">
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Sorting by a meaningful key</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Exchange argument is possible</span></div>
  <div class="learning-list__line" style="--list-indent: 0;"><span class="learning-list__marker">-</span><span>Keeping the best current option is enough</span></div>
</div>
